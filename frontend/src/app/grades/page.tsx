...
export const metadata = {
  title: "Calificaciones | Dynamic Cooperation Group",
};
  ...
  return (
    <div className="p-6 lg:p-10 w-full">
      <header className="mb-8">
        <h2 className="text-3xl font-bold text-white mb-2">Calificaciones y Entregas</h2>
        <p className="text-neutral-400">
          Revisa y califica todas las tareas entregadas por los alumnos.
        </p>
      </header>
